...
export class CouponService {
  ...
  private static getDefaultCoupons(): Coupon[] {
    ...
    return [
      ...
      },
      {
        ...
        code: 'TEST10',
        name: 'Test Discount',
        description: '10% off any plan - for testing',
        type: 'percentage',
        value: 10,
        validFrom: now,
        validUntil: nextMonth,
      ...
      },
      {
        ...
        code: 'DEMO20',
        name: 'Demo Discount',
        description: '20% off any plan - for demo purposes',
        type: 'percentage',
        value: 20,
        validFrom: now,
        validUntil: nextMonth,
  ...
  /**
   * Force refresh default data (for development)
   */
  static refreshDefaultData(): void {
    localStorage.setItem(this.STORAGE_KEY, JSON.stringify(this.getDefaultCoupons()))
    localStorage.setItem(this.DEALS_KEY, JSON.stringify(this.getDefaultDeals()))
  }
